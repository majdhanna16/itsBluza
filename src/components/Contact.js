        ...
        <div className="Contact">
            <div className="contactMethods">
                ...
                <div className="contactMethod">
                    ...
                    <p>
                        <a href={configData.facebook_link} target="_blank" rel = "noopener noreferrer">Click Here</a>
                    </p>
                </div>
                ...
                <div className="contactMethod">
                    ...
                    <p>
                        <a href={configData.instagram_link} target="_blank" rel = "noopener noreferrer">Click Here</a>
                    </p>
                </div>
            ...
            <form className="getInTouchForm" onSubmit={this.getInTouchSubmit}>
                ...
                <div className="getInTouch">
                    <div className="getInTouchData">
                        ...
                        <p className="getInTouchInputNote" style={{display: this.state.nameError_display}}>Name should contain 2-50 characters</p>
                    </div>
                    <div className="getInTouchData">
                    ...
                    <div className="getInTouchData">
                        ...
                        <p className="getInTouchInputNote" style={{display: this.state.subjectError_display}}>Subject should contain 2-120 characters.</p>
                    </div>
                </div>
